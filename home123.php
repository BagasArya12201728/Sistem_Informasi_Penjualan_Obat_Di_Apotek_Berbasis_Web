  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar bg-gradient-primary sidebar-dark accordion" id="accordionSidebar" >
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3"><img src="img/logo.png" width="230px"></div>
      </a>
 ...
 -->
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                ?> 
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><h5 style="color : black;   font-weight: 700; font-size: 14px;"><?= $data->nama ?></h5></span>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SMK Insan Mulia Yogyakarta 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
