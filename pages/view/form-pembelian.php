...
<?php// var_dump("dfd"); exit();?>
  ...
  <div class="card-body">
    <div class="my-2"></div>
    <form action="action/action?act=add-cart-pembelian" method="POST" name="form_pembelian">
      <div class="row">
        <div class="col-6">
          ...
          <?php while ($data = $result->fetch_object()) {
              echo "
               <tr>
                ...
                <td style='background-color : #DCDCDC; text-align : center;'><a href='action/action?act=del-cart-pembalian&&data=$data->kode_obat' class='fa fa-trash'></a></td>
              </tr>";
            $no++;
          } ?>
...
<!-- <select id="select2" class="form-control">
 ...
 -->
          ...
          <div style="float: right; line-height: 1px">
            <form action="action/action.php?act=simpan-pembelian" class="form-horizontal form-label-left" method="post" style="font-size: 14px">
