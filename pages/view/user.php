                    ...
                    <?php $no=1;
                      ...
                      while ($data = $res->fetch_object()) { ?>                   
                        <tr>
                          ...
                          <td><?= $data->alamat ?></td>
                          <td>
                            <a href='action/action.php?act=del-user&&username=<?php echo $data->username ?>' class='btn btn-danger btn-sm'  data-username=<?php echo $data->username ?>><span class='fa fa-trash'></span> Hapus</a>
