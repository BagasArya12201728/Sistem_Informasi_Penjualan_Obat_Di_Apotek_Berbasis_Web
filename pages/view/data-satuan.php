...
';
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table class="table " id="dataTable" width="100%" cellspacing="0" style="font-size: 12px">
                  ...
                  <?php
                    $no=1;
                    $res = $connect->query('SELECT * FROM satuan');
                    ...
                    echo"
                      ...
                      <td align=center>
                        <a href='action/action?kode=$data->kode&&act=del-satuan' class='btn btn-danger btn-sm'><span class='fa fa-trash'> hapus</span></a>
                        <a href='?p=satuan&&kode=$data->kode' class='btn btn-primary btn-sm'><span class='fa fa-edit'> ubah</span></a>
                      </td>
                      </tr>";
                    $no++;
                  }?>
  ...
  <div class="col-sm-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <?php 
                $result   = $connect->query('SELECT MAX(kode) AS kode FROM satuan');
...
<?php  if (isset($_GET['kode'])): $getdata = $_GET['kode']; ?>
              ...
              <?php 
                $result   = $connect->query("SELECT * FROM satuan WHERE kode = '$getdata' ");
                $ex       = $result->fetch_object();   
                // $nums_row = $result->num_rows;
              ?>
                <form method="POST" action="action/action?act=up-satuan" style="font-size: 12px">
                  ...
                  <button type="submit" class="btn btn-dark btn-sm" ><span class="fa fa-save"></span> Perbarui</button>
